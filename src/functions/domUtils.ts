...
/* Devuelve el estilo cssText de un elemento */
const $styleText = (getId: string): string | undefined => {
  const element = $(getId);
  return element ? element.style.cssText : undefined;
};
...
const $all = (search: string): NodeListOf<Element> => {
